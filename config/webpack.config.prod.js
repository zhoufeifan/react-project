...
const cssFilename = `caibao-center-antd/css/[name]_${version}.css`;
...
module.exports = {
    ...
    output: {
        ...
        filename: `caibao-center-antd/js/[name]_${version}.js`,
        chunkFilename: `caibao-center-antd/js/[name]_${version}.chunk.js`,
    ...
    resolve: {
        ...
        alias: {
            ...
            assets: `${config.rootPath}/src/assets`,
            root: __dirname,
    ...
    module: {
        ...
        rules: [
            ...
            // When you `import` an asset, you get its filename.
            {
                ...
                options: {
                    name: 'caibao-center-antd/media/[name].[hash:8].[ext]',
                },
            },
